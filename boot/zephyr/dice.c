...
PFR_ALIAS_CERT_INFO alias_cert_info NON_CACHED_BSS_ALIGN16;
PFR_ALIAS_CERT_INFO fl_alias_cert_info NON_CACHED_BSS_ALIGN16;
...
int dice_start(size_t cert_type, struct boot_rsp *rsp)
{
	...
	memset((void *)ALIAS_PRIV_KEY_ADDRESS, 0, 0x400);
	...
	CHK(flash_area_open(FIXED_PARTITION_ID(cert_partition), &fap));
